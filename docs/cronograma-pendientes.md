...
- Notificación de vencimiento próximo por lote — **pendiente**, no bloqueada por ninguna decisión de negocio, se puede construir en cualquier momento (usa la misma `_pendiente_por_lote` ya existente).
